	...
	<?php
		...
		if (isset($_POST['submit'])) {
			...
			if ($username == "" || $password == "" || $nisn == "" || $asalsekolah == "" || $alamat == "" || $nama == "") {
				...
				$upload = mysqli_query($koneksi, "INSERT INTO `tabel_user` (`nama_user`, `gambar_user`, `username`, `password`, `nisn`, `asalsekolah`, `alamat`) VALUES ('$nama', '$alamatfile', '$username', '$password', '$nisn', '$asalsekolah', '$alamat')", MYSQLI_USE_RESULT);
				//print_r($upload);
				if ($upload) {
					// Jika berhasil
					echo "
